...
wsk action create -i matmul1 matmul/matmul.py --docker hwnam831/mxcontainer:latest -m 4096
wsk action create -i linpack1 linpack/linpack.py --docker hwnam831/mxcontainer:latest -m 4096
...
wsk action create -i image_rotate1 image_rotate/lambda.py --docker hwnam831/mxcontainer:latest -m 4096
