...
wsk action create primes-python_socket0 functions/microbenchmarks/primes/primes-python.py --docker hwnam831/actionloop-python-v3.6-ai:latest -i
wsk action create base64-python_socket0 functions/microbenchmarks/base64/base64-python.py --docker hwnam831/actionloop-python-v3.6-ai:latest -i
...
zip -r action.zip ./*
wsk action create img-resize_socket0 --kind nodejs:14 action.zip --web raw -i -m 512
wsk action create img-resize_socket1 --kind nodejs:14 action.zip --web raw -i -m 512
cd ../markdown-to-html/
wsk action create markdown2html_socket0 markdown2html.py --docker immortalfaas/markdown-to-html --web raw -i
wsk action create markdown2html_socket1 markdown2html.py --docker immortalfaas/markdown-to-html --web raw -i
cd ../ocr-img/
wsk action create ocr-img_socket0 handler.js --docker immortalfaas/nodejs-tesseract --web raw -i -m 512
wsk action create ocr-img_socket1 handler.js --docker immortalfaas/nodejs-tesseract --web raw -i -m 512
cd ../sentiment-analysis
wsk action create sentiment_socket0 sentiment.py --docker immortalfaas/sentiment --web raw -i
